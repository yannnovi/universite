/*$Id: Batmobile.java,v 1.4 2004/04/27 16:15:25 yann Exp $*/
package tp3;
...
public String toString()
  {
      return "Batmobile : " + this.getNumero() +" : "+ this.getPrixAnnonce() +" : "+ this.getPrixCoutant() +" : " + couleur +" : "+ this.getOption1() +" : "+ this.getOption2() +" : "+ this.getOption3() +" : "+ this.getOption4() + " : " + this.getOption4() + " : " + this.getVendue();
  }
}
