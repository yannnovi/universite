/*$Id: Pinto.java,v 1.4 2004/04/27 16:15:27 yann Exp $*/
package tp3;
...
public class Pinto extends Berline
{
    ...
    {
        return "Pinto : "+ this.getNumero() +" : "+ this.getPrixAnnonce() +" : "+ this.getPrixCoutant() +" : " + couleur +" : "+ this.getOption1() +" : "+ this.getOption2() +" : "+ this.getOption3() +" : "+ this.getOption4() + " : " + this.getVendue();
    }
}
