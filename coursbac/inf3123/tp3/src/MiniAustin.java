/*$Id: MiniAustin.java,v 1.4 2004/04/27 16:15:27 yann Exp $*/
package tp3;

/**
 * <p>Title: Classe MiniAustin</p>
 * <p>Description: Classe concrete pour instancier une mini austin</p>
 * <p>Copyright: Copyright (c) 2004</p>
 * @author Framcis Goyer (GOYF14037303)
 * @version 1.0
 */

public class MiniAustin extends Compacte
{
   ...
   */
  public MiniAustin(String numeroSerie, int prixAnnonce, int prixCoutant,
   ...
   * @throws ExceptionModele
   */
  public MiniAustin(String desc) throws ExceptionAuto, ExceptionType, ExceptionModele
  {
...
public String toString()
  {
      return "MiniAustin : " +this.getNumero() +" : "+ this.getPrixAnnonce() +" : "+ this.getPrixCoutant() +" : " + couleur +" : "+ this.getOption1() +" : "+ this.getOption2() +" : "+ this.getVendue();
  }
}
