/*$Id: Papemobile.java,v 1.4 2004/04/27 16:15:27 yann Exp $*/
package tp3;

/**
 * <p>Title: Classe Papemobile</p>
 * <p>Description: Classe concrete pour instancier une papemobile super sport</p>
...
public class Papemobile extends Sport
{
   ...
   */
  public Papemobile(String numeroSerie, int prixAnnonce, int prixCoutant,
        ...
        throws ExceptionAuto, ExceptionType, ExceptionModele
    {
      ...
      if (couleur == null) {
        throw new ExceptionModele("Les options ne peuvent pas etres null.");
      }
      this.couleur = couleur;
    }

  /** Constructeur
   * @param records La chaine contenant l'information
   */
  public Papemobile(String record) throws ExceptionAuto, ExceptionType, ExceptionModele
  {
...
public String toString()
  {
      return "Papemobile : "+this.getNumero() +" : "+ this.getPrixAnnonce() +" : "+ this.getPrixCoutant() +" : " + couleur +" : "+ this.getOption1() +" : "+ this.getOption2() +" : "+ this.getOption3() +" : "+ this.getOption4() + " : " + this.getOption5() + " : " + this.getVendue();
  }
}
