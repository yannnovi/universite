-------------------------------------------------------------------------------
-- $Id: Liste_Dyn.ads,v 1.2 2003/07/16 14:30:25 yann Exp $
-------------------------------------------------------------------------------
...
PRIVATE
    Type Noeud;
    Type PtrNoeud is ACCESS Noeud;
    Type Liste is record
                    Tete        : PtrNoeud;
                    Remorque    : PtrNoeud;  -- Pointe sur le noeud bidon de fin de liste
