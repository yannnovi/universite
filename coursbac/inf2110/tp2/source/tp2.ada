------------------------------------------------------------------------------
--$Id: tp2.ada,v 1.3 2003/07/16 17:30:13 yann Exp $
------------------------------------------------------------------------------
...
procedure GestionUQAM is
   ...
   PACKAGE Liste_Cours       is new Liste_Dyn(EnregistrementCours,
                                               cle_Cours,
                                               RetourneCleCours,
                                               CoursPlusPetit);

   -- Pour la liste des etudiants.                                               
   PACKAGE Liste_Etudiant    is new Liste_Dyn(EnregistrementEtudiant,
                                              Matricule_Etudiant,
                                              RetourneCleEtudiant,
                                              EtudiantPlusPetit);
   ...
   ---------------------------------------------------------------------------
   PROCEDURE EffectuerGestionCours(ListeCours: in out Liste_cours.liste;
                                   ListeEtudiant: in out Liste_etudiant.liste) is
   ...
   --            ListeEtudiant: (IN OUT) Liste des etudiants.
   ---------------------------------------------------------------------------                                                                              
   PROCEDURE EffectuerGestionEtudiant(ListeCours: in out Liste_cours.liste;
                                      ListeEtudiant: in out Liste_etudiant.liste) is
